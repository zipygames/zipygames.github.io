...
class game {
    ...
    init() {
        ...
        mySnake[0] = new snake(playerName, this, minScore, game_W / 2, game_H / 2);
                ...
                if (i != j) {
                    ...
                    if (!kt) {
                        ...
                        if (i != 0)
                            ...
                            if (i == 0) {
                                // Save score
                                const score = Math.floor(mySnake[i].score);
                                ...
                                dialog.style.border = '2px solid #00ffcc';
                                dialog.style.borderRadius = '12px';
                                dialog.style.padding = '24px';
                                dialog.style.textAlign = 'center';
                                dialog.style.color = '#f5f5f5';
                                ...
                                dialog.innerHTML = `
                                  <h2 style="color:#00ffcc; margin-bottom:12px; font-size:1rem;">Game Over</h2>
                                  <p style="margin:10px 0; font-size:0.8rem;">Your Score: <span style="color:#ff007f">${score}</span></p>
                                  <div style="margin-top:16px; display:flex; flex-direction:column; gap:10px;">
                                    <button id="restartBtn" style="
                                      background:linear-gradient(90deg,#00ffcc,#ff007f);
                                      border:none; padding:10px; border-radius:8px;
                                      font-weight:bold; cursor:pointer;">Restart Game</button>
                                    <button id="homeBtn" style="
                                      background:transparent; border:1px solid #00ffcc;
                                      color:#00ffcc; padding:10px; border-radius:8px;
                                      cursor:pointer;">Back Home</button>
                                  </div>
                                `;
